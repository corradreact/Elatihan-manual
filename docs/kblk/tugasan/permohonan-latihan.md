...
:::
![Senarai permohonan](/image/dashboard/permohonan.png)


### 2. Melihat Permohonan Baharu
::: tip Langkah 2
1. Pada Dashboard Tugasan, semak bahagian **Sokongan Permohonan Latihan**
2. Klik pada butang **"Sokong"** permohonan yang ingin disemak untuk melihat maklumat terperinci pemohon
![Button Sokong 1](/image/dashboard/btn-sokong-lthn.png)

3. Kemudian skrin akan memaparkan maklumat yang perlu disemak termasuk: 
...
4.Klik butang **Hantar Ulasan**
![Hantar](/image/dashboard/btn-hantar.png)

5. Sistem akan memaparkan mesej berjaya seperti:
![Success 1](/image/dashboard/success-pj.png)
:::

::: warning Nota
- Minimum: 10 aksara
- Maksimum: 255 aksara
- Pastikan ulasan jelas dan berkaitan dengan permohonan yang disemak
- Status permohonan akan dikemas kini secara automatik
:::
